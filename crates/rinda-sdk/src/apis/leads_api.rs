...
pub async fn get_api_v1_leads_search(configuration: &configuration::Configuration, limit: Option<&str>, offset: Option<&str>, lead_status: Option<&str>, business_type: Option<&str>, country: Option<&str>, city: Option<&str>, search: Option<&str>, search_type: Option<&str>, workspace_ids: Option<&str>, created_by_ids: Option<&str>, customer_group_id: Option<&str>, filters: Option<&str>, sort_field: Option<&str>, sort_order: Option<&str>, created_after: Option<&str>, created_before: Option<&str>, updated_after: Option<&str>, updated_before: Option<&str>) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<GetApiV1LeadsSearchError>> {
...
pub async fn post_api_v1_leads_bulk(configuration: &configuration::Configuration, request_body: std::collections::HashMap<String, serde_json::Value>) -> Result<models::PostApiV1LeadsBulk200Response, Error<PostApiV1LeadsBulkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PostApiV1LeadsBulk200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PostApiV1LeadsBulk200Response`")))),
        }
    } else {
        let content = resp.text().await?;
